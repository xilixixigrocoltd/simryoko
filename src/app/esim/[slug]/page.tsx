  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900 text-white">
      ...
      <section id="plans" className="container mx-auto px-4 py-12">
        ...
        {/* ProductCard list will be dynamically loaded here from API */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {["1GB / 7天", "3GB / 15天", "5GB / 30天"].map((plan) => (
            <div key={plan} className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-blue-500/50 transition">
              <h3 className="text-lg font-semibold mb-2">{country.zh} {plan}</h3>
              <p className="text-sm text-gray-400 mb-4">覆盖{country.zh}全境 · 4G/5G高速网络</p>
              <a href="https://t.me/+lUV96AsCFygxNDg9" target="_blank" rel="noopener noreferrer"
